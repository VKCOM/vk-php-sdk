...
use VK\Actions\Enum\UsersRadius;
...
class Users {
	 ...
	 * @param string $access_token
	 * @param array $params 
	 * - @var number latitude: geographic latitude of the place a user is located, in degrees (from -90 to 90)
	 * - @var number longitude: geographic longitude of the place a user is located, in degrees (from -180 to 180)
	 * - @var integer accuracy: current location accuracy in meters
	 * - @var integer timeout: time when a user disappears from location search results, in seconds
	 * - @var UsersRadius radius: search zone radius type (1 to 4), :* 1 – 300 m,, :* 2 – 2400 m,, :* 3 – 18 km,, :* 4 – 150 km.
	 * - @var array[UsersFields] fields: list of additional fields to return. Available values: sex, bdate, city, country, photo_50, photo_100, photo_200_orig, photo_200, photo_400_orig, photo_max, photo_max_orig, online, online_mobile, domain, has_mobile, contacts, connections, site, education, universities, schools, can_post, can_see_all_posts, can_see_audio, can_write_private_message, status, last_seen, common_count, relation, relatives, counters, screen_name, maiden_name, timezone, occupation
	 * - @var UsersNameCase name_case: Case for declension of user name and surname: , nom –nominative (default) , gen – genitive , dat – dative , acc – accusative , ins – instrumental , abl – prepositional
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function getNearby($access_token, array $params = []) {
