...
use VK\Actions\Enum\AccountSaveProfileInfoSex;
use VK\Actions\Enum\AccountSaveProfileInfoRelation;
use VK\Actions\Enum\AccountSaveProfileInfoBdateVisibility;
...
class Account {
     ...
     *        single,, * '2' - in a relationship,, * '3' - engaged,, * '4' - married,, * '5' - it's complicated,, * '6' -
     *        actively searching,, * '7' - in love,, * '0' - not specified.
