...
use VK\Actions\Enum\AccountService;
...
class Account {
	 ...
	 * @param string $access_token
	 * @param array $params 
	 * - @var array[string] contacts: List of contacts separated with commas
	 * - @var AccountService service: String identifier of a service which contacts are used for searching. Possible values: , * email, * phone, * twitter, * facebook, * odnoklassniki, * instagram, * google
	 * - @var string mycontact: Contact of a current user on a specified service
	 * - @var boolean return_all: '1' – also return contacts found using this service before, '0' – return only contacts found using 'contacts' field.
	 * - @var array[AccountFields] fields: Profile fields to return. Possible values: 'nickname, domain, sex, bdate, city, country, timezone, photo_50, photo_100, photo_200_orig, has_mobile, contacts, education, online, relation, last_seen, status, can_write_private_message, can_see_all_posts, can_post, universities'.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function lookupContacts($access_token, array $params = []) {
