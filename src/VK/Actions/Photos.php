...
use VK\Actions\Enum\PhotosAlbumId;
...
class Photos {
	 ...
	 * - @var PhotosAlbumId album_id: Photo album ID. To return information about photos from service albums, use the following string values: 'profile, wall, saved'.
