...
use VK\Actions\Enum\PhotosGetCommentsSort;
use VK\Actions\Enum\PhotosReportReason;
use VK\Actions\Enum\PhotosReportCommentReason;
...
class Photos {
     ...
     *        a community ID.
     *      - string album_id: Photo album ID. To return information about photos from service albums, use the
     ...
     *      - PhotosReportCommentReason reason: Reason for the complaint: '0' - spam, '1' - child pornography, '2'
     *        - extremism, '3' - violence, '4' - drug propaganda, '5' - adult material, '6' - insult, abuse
