...
use VK\Actions\Enum\MessagesFilter;
use VK\Actions\Enum\MessagesMediaType;
use VK\Actions\Enum\MessagesNameCase;
use VK\Actions\Enum\MessagesRev;
...
class Messages {
	 ...
	 * @param string $access_token
	 * @param array $params 
	 * - @var string user_id: User ID. To clear a chat history use 'chat_id'
	 * - @var integer group_id: Group ID (for group messages with user access token)
	 ...
	 * - @var integer count: Number of messages to delete. "NOTE: If the number of messages exceeds the maximum, the method shall be called several times."
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function deleteDialog($access_token, array $params = []) {
	 ...
	 * - @var array[string] attachment: (Required if 'message' is not set.) List of objects attached to the message, separated by commas, in the following format: "<owner_id>_<media_id>", '' — Type of media attachment: 'photo' — photo, 'video' — video, 'audio' — audio, 'doc' — document, 'wall' — wall post, '<owner_id>' — ID of the media attachment owner. '<media_id>' — media attachment ID. Example: "photo100172_166443618"
	 ...
	 * @param string $access_token
	 * @param array $params 
	 * - @var boolean out: '1' — to return outgoing messages, '0' — to return incoming messages (default)
	 * - @var integer offset: Offset needed to return a specific subset of messages.
	 * - @var integer count: Number of messages to return.
	 * - @var integer filter: 8 - important messages
	 * - @var integer time_offset: Maximum time since a message was sent, in seconds. To return messages without a time limitation, set as '0'.
	 ...
	 * - @var integer last_message_id: ID of the message received before the message that will be returned last (provided that no more than 'count' messages were received before it, otherwise 'offset' parameter shall be used).
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	 ...
	 * - @var array[MessagesFields] fields: Profile fields to return.
	 * - @var MessagesNameCase name_case: Case for declension of user name and surname: 'nom' — nominative (default), 'gen' — genitive , 'dat' — dative, 'acc' — accusative , 'ins' — instrumental , 'abl' — prepositional
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	 ...
	 * @return mixed
	 */
	public function getChatUsers($access_token, array $params = []) {
	 ...
	 * - @var integer start_message_id: ID of the message from what to return dialogs.
	 * - @var integer preview_length: Number of characters after which to truncate a previewed message. To preview the full message, specify '0'. "NOTE: Messages are not truncated by default. Messages are truncated by words."
	 * - @var boolean unread: '1' — return conversations with unread messages only.
	 * - @var boolean important: '1' — return important conversations only.
	 * - @var boolean unanswered: '1' — return unanswered conversations only.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function getDialogs($access_token, array $params = []) {
	 ...
	 * @param string $access_token
	 * @param array $params 
	 * - @var array[integer] peer_id: IDs of messages to mark as important.
	 * - @var boolean important: '1' — to add a star (mark as important), '0' — to remove the star
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function markAsAnsweredDialog($access_token, array $params = []) {
		return $this->request->post('messages.markAsAnsweredDialog', $access_token, $params);
	}
	 ...
	 * @return mixed
	 */
	public function markAsImportantDialog($access_token, array $params = []) {
	 ...
	 * @param array $params 
	 * - @var integer chat_id: Chat ID.
	 * - @var string user_id: ID of the user to be removed from the chat.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	 ...
	 * @param array $params 
	 * - @var string q: Search query string.
	 * - @var integer limit: Maximum number of results.
	 * - @var array[MessagesFields] fields: Profile fields to return.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function searchDialogs($access_token, array $params = []) {
	 ...
	 * - @var boolean notification: '1' if the message is a notification (for community messages).
	 * - @var integer group_id: Group ID (for group messages with group access token)
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
