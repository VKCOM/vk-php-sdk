...
use VK\Actions\Enum\GroupsReason;
...
class Groups {
	 ...
	 * - @var integer group_id: Community ID.
	 * - @var integer user_id: User ID.
	 * - @var integer end_date: Date (in Unix time) when the user will be removed from the blacklist.
	 * - @var GroupsReason reason: Reason for ban: '1' — spam, '2' — verbal abuse, '3' — strong language, '4' — irrelevant messages, '0' — other (default)
	 * - @var string comment: Text of comment to ban.
	 * - @var boolean comment_visible: '1' — text of comment will be visible to the user,, '0' — text of comment will be invisible to the user. By default: '0'.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function banUser($access_token, array $params = []) {
	 ...
	 * - @var string action_button: Keywords for stopwords filter.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	 ...
	 * @param array $params 
	 * - @var integer group_id: Community ID.
	 * - @var string title: Place title.
	 * - @var string address: Place address.
	 * - @var integer country_id: Country ID.
	 * - @var integer city_id: City ID.
	 * - @var number latitude: Geographical latitude.
	 * - @var number longitude: Geographical longitude.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function editPlace($access_token, array $params = []) {
	 ...
	 * - @var string latitude: Latitude of  the user geo position.
	 * - @var string longitude: Longitude of the user geo position.
	 ...
	 * @return mixed
	 */
	public function getCallbackServerSettings($access_token, array $params = []) {
		return $this->request->post('groups.getCallbackServerSettings', $access_token, $params);
	}
	 ...
	 * @return mixed
	 */
	public function setCallbackServer($access_token, array $params = []) {
		return $this->request->post('groups.setCallbackServer', $access_token, $params);
	}
	 ...
	 * @param array $params 
	 * - @var integer group_id: Community ID.
	 * - @var string secret_key: Callback API secret key.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function setCallbackServerSettings($access_token, array $params = []) {
		return $this->request->post('groups.setCallbackServerSettings', $access_token, $params);
	}
	 ...
	 * @return mixed
	 */
	public function unbanUser($access_token, array $params = []) {
