...
use VK\Actions\Enum\FriendsGetOrder;
use VK\Actions\Enum\FriendsGetNameCase;
use VK\Actions\Enum\FriendsGetRequestsSort;
use VK\Actions\Enum\FriendsGetSuggestionsNameCase;
use VK\Actions\Enum\FriendsSearchNameCase;
...
class Friends {
     ...
     *      - boolean extended: Return friend request read_state field
     *
     * @return mixed
     * @throws VKClientException in case of network error
     * @throws VKApiException in case of API error
