...
use VK\Actions\Enum\LikesGetListFilter;
use VK\Actions\Enum\LikesGetListFriendsOnly;
...
class Likes {
     ...
     * @param $params array
     *      - string type: Object type: 'post' — post on user or community wall, 'comment' — comment on a wall
     *        post, 'photo' — photo, 'audio' — audio, 'video' — video, 'note' — note, 'photo_comment' — comment
     *        on the photo, 'video_comment' — comment on the video, 'topic_comment' — comment in the discussion,
     ...
     * @param $access_token string
     * @param $params array
     *      - string type: , Object type: 'post' — post on user or community wall, 'comment' — comment on a
     ...
     *      - LikesGetListFriendsOnly friends_only: Specifies which users are returned: '1' — to return only the
     *        current user's friends, '0' — to return all users (default)
     *        @see LikesGetListFriendsOnly
