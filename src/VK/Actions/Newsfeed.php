...
use VK\Actions\Enum\NewsfeedGetBannedNameCase;
use VK\Actions\Enum\NewsfeedUnsubscribeType;
...
class Newsfeed {
     ...
     *        new photo tags, 'wall_photo' — new wall photos, 'friend' — new friends
     ...
     *      - string source_ids: Sources to obtain news from, separated by commas. User IDs can be specified in
     ...
     * @param $access_token string
     * @param $params array
     *      - string type: Item type. Possible values: *'wall' - post on the wall,, *'tag' - tag on a photo,,
     ...
     *        negative. 'owner_id=1' - user , 'owner_id=-1' - community "
     *      - integer item_id: Item identifier
     *      - string track_code: Track code of unignored item
     *
     * @return mixed
     * @throws VKClientException in case of network error
     * @throws VKApiException in case of API error
