...
use VK\Actions\Enum\VideoGetCommentsSort;
use VK\Actions\Enum\VideoReportReason;
use VK\Actions\Enum\VideoReportCommentReason;
use VK\Actions\Enum\VideoSearchSort;
