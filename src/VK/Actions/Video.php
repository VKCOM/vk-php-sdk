...
class Video {
	...
	/**
	 * Returns a separate catalog block
	 *
	 * @param string $access_token
	 * @param array $params 
	 * - @var string block_id: 'id' value returned with a block.
	 * - @var string start_from: 'next_from' value returned with a block.
	 * - @var integer count: Number of blocks to return.
	 * - @var boolean extended: '1' - return extra information about profiles and communities
	 * - @var array[VideoFields] fields: Profiles and communities fields to return.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	public function getCatalogBlock($access_token, array $params = []) {
		return $this->request->post('video.getCatalogBlock', $access_token, $params);
	}
	 ...
	 * @return mixed
	 */
	public function getUserVideos($access_token, array $params = []) {
	 ...
	 * - @var integer owner_id: ID of the user or community that owns the video.
	 * - @var integer video_id: Video ID.
	 * - @var string tagged_name: Tag text.
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
