...
use VK\Actions\Enum\UtilsGetLinkStatsSource;
use VK\Actions\Enum\UtilsGetLinkStatsInterval;
...
class Utils {
     ...
     * @param $params array
     *      - string key: Link key (characters after vk.cc/).
     *      - UtilsGetLinkStatsSource source: Source of scope
     *        @see UtilsGetLinkStatsSource
