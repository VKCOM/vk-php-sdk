...
use VK\Actions\Enum\AdsCheckLinkLinkType;
use VK\Actions\Enum\AdsGetDemographicsIdsType;
use VK\Actions\Enum\AdsGetDemographicsPeriod;
use VK\Actions\Enum\AdsGetPostsReachIdsType;
use VK\Actions\Enum\AdsGetStatisticsIdsType;
use VK\Actions\Enum\AdsGetStatisticsPeriod;
use VK\Actions\Enum\AdsGetSuggestionsSection;
use VK\Actions\Enum\AdsGetSuggestionsLang;
use VK\Actions\Enum\AdsGetTargetingStatsAdFormat;
use VK\Actions\Enum\AdsGetUploadURLAdFormat;
...
class Ads {
     ...
     *      - array data: Serialized JSON array of objects that describe added managers. Description of
     ...
     *        that users will be automatically removed from the group.
     *      - integer target_pixel_id:
     *      - string target_pixel_rules:
     *
     * @return mixed
     * @throws VKClientException in case of network error
     * @throws VKApiException in case of API error
     ...
     *      - boolean only_deleted: Flag that specifies whether to show only archived ads: *0 — show all ads,, *1
     ...
     *
     */
    public function getLookalikeRequests(string $access_token, array $params = array()) {
     ...
     *
     */
    public function getMusicians(string $access_token, array $params = array()) {
     ...
     *
     */
    public function getMusiciansByIds(string $access_token, array $params = array()) {
     ...
     * @param $params array
     *      - integer account_id: Advertising account ID.
     *      - AdsGetPostsReachIdsType ids_type: Type of requested objects listed in 'ids' parameter: *ad — ads,,
     *        *campaign — campaigns.
     *        @see AdsGetPostsReachIdsType
     *      - string ids: IDs requested ads or campaigns, separated with a comma, depending on the value set in
     ...
     *
     */
    public function getPostsReach(string $access_token, array $params = array()) {
     ...
     *        used: *day: YYYY-MM-DD, example: 2011-09-27 — September 27, 2011, **0 — current day,, *month: YYYY-MM,
     *        example: 2011-09 — September 2011, **0 — current month,, *overall: 0.
     *      - array stats_fields: Additional fields to add to statistics
     *
     * @return mixed
     * @throws VKClientException in case of network error
     * @throws VKApiException in case of API error
     ...
     *      - boolean need_precise: Additionally return recommended cpc and cpm to reach 5,10..95 percents of
     *        audience.
     *      - integer impressions_limit_period: Impressions limit period in seconds, must be a multiple of
     *        86400(day)
     *
     * @return mixed
     * @throws VKClientException in case of network error
     ...
     *
     */
    public function updateOfficeUsers(string $access_token, array $params = array()) {
