...
class Apps {
	 ...
	 * - @var string filter: 'installed' — to return list of installed apps (only for mobile platform).
	 * @throws VKClientException
	 * @throws VKApiException
	 * @return mixed
	 */
	...
	/**
	 * Returns apps sticker achievement for user
	 *
	 * @param string $access_token
	 * @param array $params 
	 * - @var AppsState state
	 ...
	 * @return mixed
	 */
	public function getStickerAchievements($access_token, array $params = []) {
		return $this->request->post('apps.getStickerAchievements', $access_token, $params);
	}
