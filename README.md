...
This library has been created using the VK API JSON Schema. It can be found [here](https://github.com/VKCOM/vk-api-schema). It uses VK API [version](https://vk.com/dev/versions) 5.80
...
```php
$vk = new VKApiClient('5.80', VK\Client\Eums\VKLanguage::ENGLISH);
```
